...
export const DELETE_ALL_MOVIES_REQUEST = "DELETE_ALL_MOVIE_REQUEST";
export const DELETE_ALL_MOVIES_SUCCESS = "DELETE_ALL_MOVIE_SUCCESS";
export const DELETE_ALL_MOVIES_FAIL = "DELETE_ALL_MOVIE_FAIL";
